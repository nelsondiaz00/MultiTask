      ...
      >
        ...
        >
          ...
          <svg
            ...
            onClick={() => {
              props.onClosePayProcess();
              props.onClosePopup(); // Llamar a la función de cierre del StartModal
            }}
          >
            <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
          </svg>
        ...
        >
          ...
          >
            ...
            <div className="contenedores-de-modales-empresa-container29">
              ...
              >
                <span>Postulación: Nombre del trabajo</span>
                <br></br>
              </span>
              <span
                id="texto_posttrabajo"
        ...
        <PayProcess onClosePayProcess={handleClosePayProcess} />
      )}
      </div>
    )
};
    ...
    >
      ...
      >
        ...
        <div className="contenedores-de-modales-empresa-container40">
          ...
          <input type="radio" name="radio_credito" />
